...
const Podcast = () => {
    return (
        <div className="px-5 mt-20 sm:px-20 w-full bg-cover min-h-screen bg-center py-10">

            <div className="text-center mb-10">
                <h1 className="text-[#D0A151] text-2xl sm:text-[40px] font-bold uppercase">
                    PODCASTS
                </h1>
                <img
            ...
            <div className="flex flex-col lg:flex-row items-center mt-10 lg:mt-30 justify-center gap-10 lg:gap-30">
                ...
                <div className="max-w-[500px] text-left mt-6 lg:mt-0 px-2">
                    <h2 className="text-[24px] sm:text-[30px] lg:text-[50px] font-bold text-black leading-snug lg:leading-tight">
                        A podcast for <br className="hidden lg:block" /> makers and entrepreneurs
                    </h2>
                    <p className="text-black/70 mt-4 text-[13px] sm:text-[14px] leading-relaxed">
                        Welcome to our podcast series dedicated to makers and entrepreneurs.
                        Join industry leaders and innovators as they share insights, stories,
                        and practical advice to inspire your journey. Whether you’re building
                        a startup or launching your next big idea, these conversations offer
                        valuable guidance and motivation to help you succeed.
                    </p>
