          ...
          <div className="max-w-[520px] text-left">
            ...
            <div className="flex sm:flex-row gap-4">
              <button className="bg-[#D0A151] text-[10px] px-5 cursor-pointer sm:text-[12px] flex items-center gap-2 text-black font-bold sm:px-5 py-2 rounded-full hover:opacity-90 transition">
                ...
                >
                  <path
                    d="M17.7727 12.5V15.8333C17.7727 16.2754 17.5971 16.6993 17.2845 17.0118C16.972 17.3244 16.5481 17.5 16.106 17.5H4.43937C3.99734 17.5 3.57342 17.3244 3.26086 17.0118C2.9483 16.6993 2.77271 16.2754 2.77271 15.8333V12.5"
                    stroke="black"
                    strokeWidth="1.6"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M6.10596 8.33398L10.2726 12.5007L14.4393 8.33398"
                    stroke="black"
                    strokeWidth="1.6"
                    strokeLinecap="round"
                    strokeLinejoin="round"
